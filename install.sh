...
repository_url=${CODEX_ROUTER_REPOSITORY_URL:-https://github.com/mavalko13/codex-router-litellm.git}
...
if [ -z "$repo_dir" ]; then
  ...
  if [ -d "$install_dir/.git" ]; then
    ...
    case "$origin_url" in
      "$repository_url"|https://github.com/mavalko13/codex-router-litellm|https://github.com/mavalko13/codex-router-litellm.git|git@github.com:mavalko13/codex-router-litellm.git)
        ;;
      *)
